...
cklut_open_cpp <- function(meta_path, warm = FALSE) {
    .Call(`_CKutils_cklut_open_cpp`, meta_path, warm)
}

cklut_schema_cpp <- function(xp) {
    .Call(`_CKutils_cklut_schema_cpp`, xp)
}

cklut_rownum_cpp <- function(xp, keys) {
    .Call(`_CKutils_cklut_rownum_cpp`, xp, keys)
}

cklut_gather_cpp <- function(xp, rownum) {
    .Call(`_CKutils_cklut_gather_cpp`, xp, rownum)
}

cklut_build_cpp <- function(out_base, dim_names, dim_is_string, dim_min, dim_size, dim_cats, dim_index, value_names, value_types, value_data, value_levels, max_bytes) {
    invisible(.Call(`_CKutils_cklut_build_cpp`, out_base, dim_names, dim_is_string, dim_min, dim_size, dim_cats, dim_index, value_names, value_types, value_data, value_levels, max_bytes))
}
